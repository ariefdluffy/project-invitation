...
import { _ as text_decoder, a as split_remote_key, b as once, g as get_relative_path, h as base64_encode, i as parse_remote_arg, l as validate_depends, m as normalize_error, n as TRAILING_SLASH_PARAM, o as stringify, p as get_status, r as create_remote_key, t as INVALIDATED_PARAM, u as validate_load_response, v as text_encoder, y as noop } from "./chunks/shared.js";
import { E as PAGE_METHODS, a as get_node_type, c as has_prerendered_path, d as serialize_uses, f as static_error_page, g as negotiate, h as is_form_content_type, i as get_global_name, l as method_not_allowed, m as s, n as count_non_ssi_comments, o as handle_error_and_jsonify, p as escape_html, r as format_server_error, s as handle_fatal_error, t as clarify_devalue_error, u as redirect_response, w as ENDPOINT_METHODS, y as deserialize_binary_form } from "./chunks/utils.js";
import { a as set_public_env, i as set_private_env, r as public_env } from "./chunks/shared-server.js";
import { _ as has_data_suffix, a as validate_server_exports, b as strip_resolution_suffix, c as SCHEME, d as make_trackable, f as normalize_path, g as add_resolution_suffix, h as add_data_suffix, i as validate_page_server_exports, l as decode_pathname, m as noop_span, n as validate_layout_server_exports, o as find_route, p as resolve, r as validate_page_exports, s as hash, t as validate_layout_exports, u as disable_search, v as has_resolution_suffix, x as compact, y as strip_data_suffix } from "./chunks/exports.js";
...
var BaseProvider = class {
	...
	*/
	constructor(use_hashes, directives, nonce) {
		...
		if (effective_style_src && !effective_style_src.includes("unsafe-inline")) d["style-src"] = [...effective_style_src.filter((value) => !(value.startsWith("sha256-") || value.startsWith("nonce-"))), "unsafe-inline"];
		if (style_src_attr && !style_src_attr.includes("unsafe-inline")) d["style-src-attr"] = [...style_src_attr.filter((value) => !(value.startsWith("sha256-") || value.startsWith("nonce-"))), "unsafe-inline"];
		if (style_src_elem && !style_src_elem.includes("unsafe-inline")) d["style-src-elem"] = [...style_src_elem.filter((value) => !(value.startsWith("sha256-") || value.startsWith("nonce-"))), "unsafe-inline"];
	...
	*/
	function set_internal(name, value, options) {
		...
		new_cookies.set(cookie_key, cookie);
		{
			...
			if (text_encoder.encode(serialized).byteLength > MAX_COOKIE_SIZE) throw new Error(`Cookie "${name}" is too large, and will be discarded by the browser`);
...
/** @type {Set<string>} */
var VALID_CACHE_CONTROL_DIRECTIVES = new Set([
	"max-age",
	"public",
	"private",
	"no-cache",
