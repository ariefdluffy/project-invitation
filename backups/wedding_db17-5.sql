...
-- Dumping data for table wedding_db.audit_logs: ~6 rows (approximately)
...
-- Dumping data for table wedding_db.settings: ~12 rows (approximately)
...
INSERT INTO `settings` (`key`, `value`, `updated_at`) VALUES
	...
	('turnstile_site_key', '1x00000000000000000000AA', '2026-05-16 15:17:48');
...
INSERT INTO `templates` (`id`, `name`, `slug`, `description`, `thumbnail`, `primary_color`, `secondary_color`, `accent_color`, `font_family`, `layout_style`, `category`, `created_at`) VALUES
	...
	('tmpl-aqiqah-blue', 'Baby Blue Aqiqah', 'tmpl-aqiqah-blue', 'Desain yang lembut dan ceria untuk perayaan aqiqah putra atau putri Anda.', 'https://images.unsplash.com/photo-1596701062351-8c2c14d1fdd0?auto=format&fit=crop&w=600&q=80', '#1e40af', '#bfdbfe', '#eff6ff', 'Playfair Display', 'classic', 'aqiqah', '2026-05-16 16:53:04'),
	('tmpl-aqiqah-soft', 'Aqiqah Blush', 'tmpl-aqiqah-soft', 'Lembut dengan krem dan blush pink, nuansa menggemaskan untuk aqiqah dan selamatan kelahiran.', 'https://images.unsplash.com/photo-1519689680058-324335c77eba?auto=format&fit=crop&w=600&q=80', '#9d174d', '#fbcfe8', '#fff1f2', 'Playfair Display', 'classic', 'aqiqah', '2026-05-16 16:53:04'),
	('tmpl-arisan-keluarga', 'Arisan Keluarga', 'tmpl-arisan-keluarga', 'Template santai dan hangat untuk acara kumpul keluarga atau arisan.', 'https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=600&q=80', '#78350f', '#fde68a', '#fefce8', 'Playfair Display', 'classic', 'gathering', '2026-05-16 16:53:04'),
	('tmpl-birthday-pop', 'Birthday Confetti', 'tmpl-birthday-pop', 'Warna-warni ceria dan kontras tegas — cocok untuk pesta ulang tahun anak maupun dewasa.', 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?auto=format&fit=crop&w=600&q=80', '#7c3aed', '#f472b6', '#faf5ff', 'Playfair Display', 'classic', 'birthday', '2026-05-16 16:53:04'),
	('tmpl-corporate-summit', 'Summit Corporate', 'tmpl-corporate-summit', 'Bersih dan profesional dengan slate dan biru — untuk seminar, launching, atau undangan formal perusahaan.', 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=600&q=80', '#1e293b', '#38bdf8', '#f8fafc', 'Playfair Display', 'classic', 'formal', '2026-05-16 16:53:04'),
	('tmpl-gathering-bistro', 'Gathering Bistro', 'tmpl-gathering-bistro', 'Hangat seperti kafe: terracotta dan krem. Cocok untuk arisan, reunion keluarga, atau bukber.', 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=600&q=80', '#9a3412', '#fdba74', '#fff7ed', 'Playfair Display', 'classic', 'gathering', '2026-05-16 16:53:04'),
	...
	('tmpl-royal', 'Royal Midnight', 'tmpl-royal', 'Perpaduan mewah warna biru tengah malam dan emas champagne, menciptakan kesan agung dan eksklusif.', 'https://images.unsplash.com/photo-1510076857177-7470076d4098?auto=format&fit=crop&w=600&q=80', '#0f172a', '#c0a080', '#ffffff', 'Cinzel', 'classic', 'pernikahan', '2026-05-16 16:53:04'),
	('tmpl-tema-31-inspired', 'Tema 31 Inspired', 'tmpl-tema-31-inspired', 'Romantic photo-centric layout with soft glass cards, floating ornaments, and cinematic typography for a modern classic wedding.', 'https://images.unsplash.com/photo-1496307042754-b4aa456c4a2d?auto=format&fit=crop&w=600&q=80', '#d4a574', '#1f2937', '#fdf7ef', 'Cormorant Garamond', 'romantic', 'pernikahan', '2026-05-16 16:53:04');
