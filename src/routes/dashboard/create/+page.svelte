<script lang="ts">
  ...
  import type { Template } from '$lib/server/invitations';
  import {
  ...
  let previewingTemplate = $state<Template | null>(null);
        ...
        <div class="modal-body demo-body">
          ...
          <div class="preview-details">
            ...
            <div class="color-chips">
              <span
                class="chip"
                style="background: {pt.primary_color}"
                title="Primary"
              ></span>
              <span
                class="chip"
                style="background: {pt.secondary_color}"
                title="Secondary"
              ></span>
              <span
                class="chip"
                style="background: {pt.accent_color}"
                title="Accent"
              ></span>
            </div>
          </div>
